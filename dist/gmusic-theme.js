    ...
    */
    ...
    value: function updateTheme(colorObject) {
      ...
      if (colorObject.type !== undefined && GMusicTheme.TYPES[colorObject.type] === undefined) {
        var validTypesStr = JSON.stringify(Object.keys(GMusicTheme.TYPES));
    ...
    value: function _substituteColors(styleString) {
      ...
      return styleString.replace(/<<BACK_PRIMARY>>/g, this.BACK_PRIMARY).replace(/<<BACK_SECONDARY>>/g, this.BACK_SECONDARY).replace(/<<BACK_HIGHLIGHT>>/g, this.BACK_HIGHLIGHT).replace(/<<FORE_PRIMARY>>/g, this.FORE_PRIMARY).replace(/<<FORE_PRIMARY_MUTED>>/g, this._darken(this.FORE_PRIMARY, 0.4)).replace(/<<FORE_SECONDARY>>/g, this.FORE_SECONDARY).replace(/<<BACK_SECONDARY_O>>/g, this._rgba(this.BACK_SECONDARY, 0.5)).replace(/<<INVERSE>>(.+?)<<\/INVERSE>>/g, function (s, colorString) {
...
},{"base64-js":3,"ieee754":13,"isarray":14}],5:[function(require,module,exports){
(function (Buffer){
var clone = (function() {
'use strict';
...
},{"./css-keywords":7}],7:[function(require,module,exports){
module.exports = {
...
},{"./conversions":6,"./route":9}],9:[function(require,module,exports){
var conversions = require('./conversions');
...
},{"./conversions":6}],10:[function(require,module,exports){
module.exports = {
	"aliceblue": [240, 248, 255],
	"antiquewhite": [250, 235, 215],
	"aqua": [0, 255, 255],
...
},{"color-name":10}],12:[function(require,module,exports){
/* MIT license */
...
},{"clone":5,"color-convert":8,"color-string":11}],13:[function(require,module,exports){
